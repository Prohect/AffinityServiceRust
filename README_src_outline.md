...
- [L463:L761]fn parse_and_insert_rules(members: &[String], rule_parts: &[&str], line_number: usize, cpu_aliases: &HashMap<String, Vec<u32>>, result: &mut ConfigResult) 
- [L763:L850]fn read_config<P: AsRef<Path>>(path: P) -> ConfigResult 
- [L896:L906]fn read_list<P: AsRef<Path>>(path: P) -> io::Result<Vec<String>> 
- [L908:L913]fn read_utf16le_file(path: &str) -> io::Result<String> 
- [L915:L921]fn parse_mask(s: &str) -> usize 
- [L923:L1095]fn convert(in_file: Option<String>, out_file: Option<String>) 
- [L1097:L1334]fn sort_and_group_config(in_file: Option<String>, out_file: Option<String>) 
