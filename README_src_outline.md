...
- [L178:L289]fn prefetch_all_thread_cycles(
    pid: u32,
    process_name: &str,
    processes: &mut Option<&mut ProcessSnapshot>,
...
- [L101:L173]fn process_logs(configs: &HashMap<u32, HashMap<String, ProcessConfig>>, blacklist: &[String], logs_path: Option<&str>, output_file: Option<&str>) 
- [L175:L426]fn main() -> windows::core::Result<()> 
...
- [L200:L207]struct ProcessStats {
    pub alive: bool,
    pub tid_to_thread_stats: HashMap<u32, ThreadStats>,
    pub track_top_x_threads: i32,
    pub process_name: String,
}
- [L226:L239]struct IdealProcessorState {
