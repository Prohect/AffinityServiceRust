...
/// Returns the module name + offset (e.g., "ntdll.dll+0x1C320").
...
///
/// # Returns
/// A string like "ntdll.dll+0x1C320" or "0x00007FFC36BDC320"
pub fn resolve_address_to_module(pid: u32, address: usize) -> String {
    ...
    // Find which module contains this address and return name+offset
